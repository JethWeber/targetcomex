...
VALUES
    ...
    -- Vendedor  (senha: User1-2026)
    ('Maria Vendedora', 'maria@target.ao',   '$2b$11$.N2psXeibzSXMAp8R8zFrOOohbULNQ0xtMcO43d.Ab0a79SDd4RT2', 'vendedor', '1990-07-22', 'F', 'Solteira',  0, 'Vendedora',  'Média-Alta', 'conforto,tecnologia',          'Profissional'),
    ...
    ('Carla Rodrigues', 'carla@target.ao',   '$2b$11$.N2psXeibzSXMAp8R8zFrOOohbULNQ0xtMcO43d.Ab0a79SDd4RT2', 'cliente',  '1995-01-30', 'F', 'Solteira',  0, 'Designer',   'Média',      'design,tecnologia,luxo',       'Uso urbano'),
    ('Pedro Lopes',     'pedro@target.ao',   '$2b$11$.N2psXeibzSXMAp8R8zFrOOohbULNQ0xtMcO43d.Ab0a79SDd4RT2', 'cliente',  '1982-11-05', 'M', 'Divorciado',1, 'Engenheiro', 'Alta',       'tecnologia,conforto,design',   'Executivo'),
    ('Ana Fernandes',   'ana@target.ao',     '$2b$11$.N2psXeibzSXMAp8R8zFrOOohbULNQ0xtMcO43d.Ab0a79SDd4RT2', 'cliente',  '1993-06-18', 'F', 'Casada',    2, 'Médica',     'Alta',       'conforto,família,espaço',      'Uso familiar premium'),
    ('Miguel Costa',    'miguel@target.ao',  '$2b$11$.N2psXeibzSXMAp8R8zFrOOohbULNQ0xtMcO43d.Ab0a79SDd4RT2', 'cliente',  '1979-04-25', 'M', 'Casado',    3, 'Agricultor', 'Média',      'robustez,off-road,espaço',     'Trabalho rural'),
    ('Sofia Neto',      'sofia@target.ao',   '$2b$11$.N2psXeibzSXMAp8R8zFrOOohbULNQ0xtMcO43d.Ab0a79SDd4RT2', 'cliente',  '1998-09-12', 'F', 'Solteira',  0, 'Estudante',  'Baixa',      'economia,design,tecnologia',   'Uso urbano econômico'),
    ('Carlos Baptista', 'carlos@target.ao',  '$2b$11$.N2psXeibzSXMAp8R8zFrOOohbULNQ0xtMcO43d.Ab0a79SDd4RT2', 'cliente',  '1970-12-03', 'M', 'Casado',    5, 'Empresário', 'Alta',       'luxo,conforto,família,espaço', 'Família grande premium');
GO
...
INSERT INTO Avaliacoes (VeiculoId, UsuarioId, Nota, Comentario, DataAvaliacao) VALUES
    ...
    (7,  10, 5, 'Luxo completo. Interior magnífico. Família ficou encantada.',                         DATEADD(month, -1, GETDATE())),
